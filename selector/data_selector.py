...
from dataset.InSARDLPUMatV1 import InSARDLPUMatV1
...
class SyntheticPUMatMidDataLoader(BaseDataLoader):
    ...
    @cached_property
    def train_dataset(self):
        return SyntheticPUMatMid(root=self.config.io.in_dataset_path, split='train',
                              transform=self.transform,
                              target_transform=self.gt_transform,
                              joint_transform=self.joint_transform,
    ...
    @cached_property
    def test_dataset(self):
        return SyntheticPUMatMid(root=self.config.io.in_dataset_path, split='test',
                              transform=self.eval_transform,
                              target_transform=self.eval_gt_transform,
                              joint_transform=self.eval_joint_transform,
                              mean = self.config.data.mean,
...
@register_data_loader(name=['xSyntheticPUMatCut32Mid','xSyntheticPUMatCut32MidTest'])
class SyntheticPUMatMidCutDataLoader(BaseDataLoader):

    @cached_property
    def train_dataset(self):
        return SyntheticPUMatCutMid(root=self.config.io.in_dataset_path, split='train',
                                 transform=self.transform,
                                 target_transform=self.gt_transform,
                                 joint_transform=self.joint_transform,
                                 mean = self.config.data.mean,
    ...
    @cached_property
    def test_dataset(self):
        return SyntheticPUMatCutMid(root=self.config.io.in_dataset_path, split='test',
                                 transform=self.eval_transform,
                                 target_transform=self.eval_gt_transform,
                                 joint_transform=self.eval_joint_transform,
                                 mean = self.config.data.mean,
...
@register_data_loader(name=['SyntheticPUMatCut','SyntheticPUMatCut128Big','SyntheticPUMatCut32','SyntheticPUMatCut32Big','SyntheticPUMatCut32Test','SyntheticPUMatCut64','SyntheticPUMatCut64Test','SyntheticPUMatCut32Mch','SyntheticPUMatCut32MchTest','SyntheticPUMatCut32Mid','SyntheticPUMatCut32MidTest'])
...
@register_data_loader(name=['SyntheticPUMatCut32Wav','SyntheticPUMatCut32WavTest'])
class SyntheticPUMatCutWavDataLoader(BaseDataLoader):

    @cached_property
    def train_dataset(self):
        return SyntheticPUMatCutWav(root=self.config.io.in_dataset_path, split='train',
                                 transform=self.transform,
                                 target_transform=self.gt_transform,
                                 joint_transform=self.joint_transform,
                                 k_max=self.config.data.k_max,
    ...
    @cached_property
    def test_dataset(self):
        return SyntheticPUMatCutWav(root=self.config.io.in_dataset_path, split='test',
                                 transform=self.eval_transform,
                                 target_transform=self.eval_gt_transform,
                                 joint_transform=self.eval_joint_transform,
                                 k_max=self.config.data.k_max,
...
@register_data_loader(name=['InSARDLPUMat256Big','InSARDLPUMat256Test','InSARDLPUMat256BigV2'])
...
class InSARDLPUMatDataLoaderV1(BaseDataLoader):
    ...
    @cached_property
    def test_dataset(self):
        return InSARDLPUMatV1(root=self.config.io.in_dataset_path, split='test',
                            transform=self.transform,
                            target_transform=self.gt_transform,
                            joint_transform=self.joint_transform,
                            k_max=self.config.data.k_max,
...
@register_data_loader(name=['SyntheticPUMat128Test','SyntheticPUMat128Big','SyntheticPUMat128BigV2'])
...
class SyntheticPUMatDataLoaderV1(BaseDataLoader):
    ...
    @cached_property
    def train_dataset(self):
        return SyntheticPUMatV1(root=self.config.io.in_dataset_path, split='train',
                              transform=self.transform,
                              target_transform=self.gt_transform,
                              joint_transform=self.joint_transform,
                              k_max=self.config.data.k_max,
    ...
    @cached_property
    def test_dataset(self):
        return SyntheticPUMatV1(root=self.config.io.in_dataset_path, split='test',
                              transform=self.transform,
                              target_transform=self.gt_transform,
                              joint_transform=self.joint_transform,
                              k_max=self.config.data.k_max,
...
class SyntheticPUMatMchDataLoader(BaseDataLoader):
    ...
    @cached_property
    def train_dataset(self):
        return SyntheticPUMatMch(root=self.config.io.in_dataset_path, split='train',
                              transform=self.transform,
                              target_transform=self.gt_transform,
                              joint_transform=self.joint_transform,
                              k_max=self.config.data.k_max,
    ...
    @cached_property
    def test_dataset(self):
        return SyntheticPUMatMch(root=self.config.io.in_dataset_path, split='test',
                              transform=self.transform,
                              target_transform=self.gt_transform,
                              joint_transform=self.joint_transform,
                              k_max=self.config.data.k_max,
...
@register_data_loader(name=['SyntheticPUMat128Dfn'])
class SyntheticPUMatDfnDataLoader(BaseDataLoader):

    @cached_property
    def train_dataset(self):
        return SyntheticPUMatDfn(root=self.config.io.in_dataset_path, split='train',
                                 transform=self.transform,
                                 target_transform=self.gt_transform,
                                 joint_transform=self.joint_transform,
                                 k_max=self.config.data.k_max,
    ...
    @cached_property
    def test_dataset(self):
        return SyntheticPUMatDfn(root=self.config.io.in_dataset_path, split='test',
                                 transform=self.transform,
                                 target_transform=self.gt_transform,
                                 joint_transform=self.joint_transform,
                                 k_max=self.config.data.k_max,
...
class SyntheticPUMatNoiseDataLoader(BaseDataLoader):
    ...
    @cached_property
    def train_dataset(self):
        return SyntheticPUMatNoise(root=self.config.io.in_dataset_path, split='train',
                                 transform=self.transform,
                                 target_transform=self.gt_transform,
                                 joint_transform=self.joint_transform,
                                 k_max=self.config.data.k_max,
    ...
    @cached_property
    def test_dataset(self):
        return SyntheticPUMatNoise(root=self.config.io.in_dataset_path, split='test',
                                 transform=self.eval_transform,
                                 target_transform=self.eval_gt_transform,
                                 joint_transform=self.eval_joint_transform,
                                 k_max=self.config.data.k_max,
