"""Create GIS boundary files for the RTS source regions and spatial splits."""
...
CONFIG = ROOT / "configs" / "rts" / "regions.yaml"
OUTPUT = ROOT / "data" / "rts_sources" / "regions"
WGS84_ESRI_WKT = (
...
def main() -> None:
    ...
    regions_stem = OUTPUT / "rts_regions"
    splits_stem = OUTPUT / "rts_spatial_splits"
    ...
    (OUTPUT / "rts_region_vectors.json").write_text(
