...
@register_diffusion(name='CfgDDPMDiffusion')
class CfgDDPMDiffusion:
    ...
    def train_sample(self, t):
        ...
        noise_u, noise_c = noise_pred.chunk(2, dim=1)
        self.noise_pred = noise_u + self.config.diffusion.cfg_scale * (noise_c - noise_u)
