...
@register_diffusion(name='FduDDPMDiffusionV5')
class FduDDPMDiffusionV5:
    ...
    def train_sample(self, t):
        ...
        self.pred_unwrapped = self.pred_unwrapped_norm * (2 * torch.pi * (self.config.data.k_max - self.config.data.k_min)) + 2 * torch.pi * self.config.data.k_min
